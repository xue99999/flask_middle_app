...
from flask_middle_app.models import db, User, Course, Chapter
...
def iter_courses():
   ...
   #     courses = json.load(f).encode('utf-8')
        
    path = os.path.join(os.path.dirname(__file__), '..', 'datas', 'courses.json')
